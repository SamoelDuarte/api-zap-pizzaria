...
<head>
  ...
  <title>{{ $globalConfig->nome_pizzaria ?? 'Integra Pizzaria' }}</title>
...
<body>
  ...
  <div class="container">
    <div class="logo"><i class="fa-solid fa-pizza-slice"></i> {{ $globalConfig->nome_pizzaria ?? 'Integra Pizzaria' }}</div>
    <h1>Bem-vindo!</h1>
